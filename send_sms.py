...
API_KEY = os.getenv('TEXT_API_KEY') or os.getenv('secrets.TEXT_API_KEY')
phone = os.getenv('PHONE_NUMBER') or os.getenv('secrets.PHONE_NUMBER')

# RETRIEVE EMAIL SETTINGS FOR CONFIRMATION
smtp_server = os.environ.get('SMTP_SERVER') or os.environ.get('secrets.SMTP_SERVER')
